...
- **Streamlit dashboard** (`dashboard/`) — 6 pages: Overview, Revenue, Customers, Products, Locations, Segmentation
- **Python utilities** (`python/`) — DB connector, plotting theme, health-check/exploration scripts
...
- [ ] Additional export/reporting integrations
